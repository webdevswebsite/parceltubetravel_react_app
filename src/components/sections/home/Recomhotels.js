                ...
                <div className="container">
                    <div className="section-header">
                        <div className="section-heading">
                            <h3 className="text-custom-black">Visits</h3>
                            <div className="section-description">
                                <p className="text-light-dark">Theses are locations where you can feel healthier, happier and less stressed than before.</p>
                            </div>
                        </div>
                    </div>
                    <div className="row">
