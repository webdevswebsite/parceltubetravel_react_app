...
import accomodation from "../../data/hotels/accomodation.json";
import amenities from "../../data/hotels/amenities.json";
...
class Hotelsidebar extends Component {
    ...
    onPriceChange(event) {
        ...
        if (this.state.maxPrice !== 0 && this.state.minPrice !== 0) {
            this.props.history.push(`/hotel/${this.state.minPrice}/${this.state.maxPrice}`);
        }
    }
    render() {
        return (
            <div className="sidebar">
                ...
                <div className="sidebar_widgets mb-xl-30">
                    <div className="widget_title bg-custom-blue">
                        <h5 className="no-margin text-custom-white">Accomodation</h5>
                    </div>
                ...
                <div className="sidebar_widgets mb-xl-30">
                    <div className="widget_title bg-custom-blue">
                        <h5 className="no-margin text-custom-white">Amenities</h5>
                    </div>
                    <form className="checkbox-group">
                        {/* Data */}
